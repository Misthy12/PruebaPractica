        ...
        <div class="row col-12">
            <div class="col-md-4 col-sm-12">
              ...
              <div class="small-box bg-warning">
                <div class="inner">
                  <h2 class="font-weight-bold">Evaluaciones Futuras</h2>
                  <h3><?php
                    if(evalDeUnDocente($_SESSION["id"])!=0){
                          echo (evalFuturas($_SESSION["id"])/evalDeUnDocente($_SESSION["id"])*100);
                ...
                <div class="progress">
                  <div class="progress-bar progress-bar-striped progress-bar-animated bg-warning" role="progressbar" aria-valuenow=" <?php  echo(evalFuturas($_SESSION["id"])/evalDeUnDocente($_SESSION["id"]))*100; ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php  echo(evalFuturas($_SESSION["id"])/evalDeUnDocente($_SESSION["id"]))*100;?>%">
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-4 col-sm-12">
              ...
              <div class="small-box bg-danger">
                <div class="inner">
                  <h2  class="font-weight-bold">Evaluaciones Vencidas</h2>
                  <h3><?php 
                   if(evalDeUnDocente($_SESSION["id"])!=0) { 
                       echo (evalVencidas($_SESSION["id"])/evalDeUnDocente($_SESSION["id"])*100);
                    }else{echo 0;} ?><sup style="font-size: 20px">%</sup></h3>
                </div>
                <div class="icon">
                ...
                <div class="progress">
                  <div class="progress-bar progress-bar-striped progress-bar-animated bg-danger" role="progressbar" aria-valuenow=" <?php echo(evalVencidas($_SESSION["id"])/evalDeUnDocente($_SESSION["id"]))*100;?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo(evalVencidas($_SESSION["id"])/evalDeUnDocente($_SESSION["id"]))*100; ?>%"></div>
                </div>
              </div>
            </div>
            <div class="col-md-4 col-sm-12">
